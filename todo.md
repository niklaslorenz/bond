...
- [x] Implement new command handler
...
- [x] Create interactive tool environment for tui
- [x] Make crop and delete commands delete turns instead of messages to prevent invalid conversation states
...
- [x] Stop Event should be explicitly handled in waitforcommandresponse tui state as commands can quit the app
